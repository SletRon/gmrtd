...
## [0.12.0](https://github.com/SletRon/gmrtd/compare/v0.11.0...v0.12.0) (2025-11-05)


### Features

* (ECDSA) Active auth signature validation ([#62](https://github.com/SletRon/gmrtd/issues/62)) ([468430c](https://github.com/SletRon/gmrtd/commit/468430c7bd763d6e5903ccd73814b65fb20e064b))
* [fixes [#67](https://github.com/SletRon/gmrtd/issues/67)] update DE Master List to Aug 2025 version ([#68](https://github.com/SletRon/gmrtd/issues/68)) ([7c12bb3](https://github.com/SletRon/gmrtd/commit/7c12bb30b6fb5460afabcc5613918f1d7191136d))
* add mobile package ([#35](https://github.com/SletRon/gmrtd/issues/35)) ([4351f71](https://github.com/SletRon/gmrtd/commit/4351f71c4cd544b5d44d066c948a2569da6a035d))
* add pcsc-reader app ([#41](https://github.com/SletRon/gmrtd/issues/41)) ([fe3f726](https://github.com/SletRon/gmrtd/commit/fe3f7265fede495c525bd67d02ffb69498be7764))
* add support for ISO-39794 ([#38](https://github.com/SletRon/gmrtd/issues/38)) ([ad82044](https://github.com/SletRon/gmrtd/commit/ad8204401fd827bd91c99eb6fb283620b18c1c1a))
* align DG2 images with DG7 ([#82](https://github.com/SletRon/gmrtd/issues/82)) ([73cb65b](https://github.com/SletRon/gmrtd/commit/73cb65ba014cd8c1ec5b07472ac92e034fb18a43))
* CSCA master-list enhancements ([#25](https://github.com/SletRon/gmrtd/issues/25)) ([3a5c3ad](https://github.com/SletRon/gmrtd/commit/3a5c3adb11646d40d5161f95863de0b56964cceb))
* moved DG hash checks to PassiveAuth (from Reader) ([#27](https://github.com/SletRon/gmrtd/issues/27)) ([9d81a43](https://github.com/SletRon/gmrtd/commit/9d81a43ec6d5d072d47c617dab79f059c2da887e))
* moved JSON document retrieval to GetDocumentJson ([#72](https://github.com/SletRon/gmrtd/issues/72)) ([938f412](https://github.com/SletRon/gmrtd/commit/938f41224636e56c0714fa3e1477f975484d91e3))
* update DE CSCA master list (fixes [#90](https://github.com/SletRon/gmrtd/issues/90)) ([#91](https://github.com/SletRon/gmrtd/issues/91)) ([f08ef19](https://github.com/SletRon/gmrtd/commit/f08ef19902c291ee02308c4d73e0f7ce711f5d6e))


### Bug Fixes

* android library issues ([#77](https://github.com/SletRon/gmrtd/issues/77)) ([5253e64](https://github.com/SletRon/gmrtd/commit/5253e64ad29dbe74cb4693427026a3ea197452ac))
* case insensitive country lookup ([#84](https://github.com/SletRon/gmrtd/issues/84)) ([2b0abcc](https://github.com/SletRon/gmrtd/commit/2b0abcc354a31f650a7ad9d8881c9cb16bbcbf50))
* don't panic in processResponse when bad data length ([#31](https://github.com/SletRon/gmrtd/issues/31)) ([7c43eeb](https://github.com/SletRon/gmrtd/commit/7c43eeb381ea253a50e87acf5cac6f7681a10dac))
* only consider EC keys (getIcPubKeyECForCAM) ([#48](https://github.com/SletRon/gmrtd/issues/48)) ([8906cca](https://github.com/SletRon/gmrtd/commit/8906cca08c515874730cc8e8ba62594ab48bddf7))
* release-please config ([#22](https://github.com/SletRon/gmrtd/issues/22)) ([e1d841e](https://github.com/SletRon/gmrtd/commit/e1d841e3545aaf686c85f63827de50be86b3c69a))
* update to make JSON field name consistent ([#70](https://github.com/SletRon/gmrtd/issues/70)) ([a459bc4](https://github.com/SletRon/gmrtd/commit/a459bc4d1f3d0e3595db203deca2a767a2bc74d1))
